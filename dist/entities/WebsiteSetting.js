...
exports.WebsiteSetting = void 0;
const typeorm_1 = require("typeorm");
let WebsiteSetting = class WebsiteSetting {
    id;
    key; // e.g., 'logo_url', 'homepage_banner', 'meta_title', 'about_origin'
    value; // Stores text, html, or JSON stringified settings
    description;
};
...
exports.WebsiteSetting = WebsiteSetting = __decorate([
    (0, typeorm_1.Entity)("website_settings")
], WebsiteSetting);
